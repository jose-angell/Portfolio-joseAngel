  ...
  const projects = [
    {
      ...
      technologies: [".NET 8","C#", "Stripe", "PostgreSQL", "TypeScript","React", "Tailwind CSS", "Docusaurus"],
      liveUrl: "https://jose-angell.github.io/EventResourceReservationAppDocs/",
      githubUrl: "https://github.com/jose-angell/EventResourceReservationAppDocs",
    },
    {
